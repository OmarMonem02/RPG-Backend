        ...
        return [
            'products' => [
                ...
                'columns' => [
                    ...
                    $this->column('have_commission', 'Have Commission', false, 'boolean', 'Yes/No, true/false, or 1/0.'),
                    $this->column('notes', 'Notes', false, 'text', 'Internal notes.'),
                    $this->column('bike_blueprints', 'Compatible Bike Blueprints', false, 'reference_list', 'Optional list: Brand | Model | Year or Brand | Model | (YearFrom-YearTo); separate multiple entries with semicolons.', reference: 'bike_blueprints.brand_model_year'),
